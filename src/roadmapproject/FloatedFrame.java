...
public class FloatedFrame extends JComponent implements SwingConstants, Accessible
{
    private static final String uiClassID = "FloatedFrameUI";
    ...
    public FloatedFrame( int orientation ){
        this(null, orientation);
    }
    public FloatedFrame( String name ) {
        this(name, HORIZONTAL);
    }
    public FloatedFrame( String name , int orientation) {
        setName(name);
        checkOrientation( orientation );

        this.orientation = orientation;
        FloatedFrame.DefaultFloatedFrameLayout layout =  new FloatedFrame.DefaultFloatedFrameLayout( orientation );
        setLayout( layout );
     ...
     * @see #setUI
     */
    public FloatedFrameUI getUI() {
        return (FloatedFrameUI)ui;
    }
     ...
     */
    public void setUI(FloatedFrameUI ui) {
        super.setUI(ui);
    }
    ...
    public void updateUI() {
        setUI((FloatedFrameUI)UIManager.getUI(this));
        invalidate();
    }
...
//        }
    ...
    private class DefaultFloatedFrameLayout
            implements LayoutManager2, Serializable, PropertyChangeListener, UIResource {

        LayoutManager layoutManager;

        DefaultFloatedFrameLayout(int orientation) {
            if (orientation == JToolBar.VERTICAL) {
                layoutManager = new BoxLayout(FloatedFrame.this, BoxLayout.PAGE_AXIS);
            } else {
                layoutManager = new BoxLayout(FloatedFrame.this, BoxLayout.LINE_AXIS);
            }
        }
        ...
        public Dimension preferredLayoutSize(Container target) {
            return layoutManager.preferredLayoutSize(target);
        }

        public Dimension minimumLayoutSize(Container target) {
            return layoutManager.minimumLayoutSize(target);
        }

        public Dimension maximumLayoutSize(Container target) {
            if (layoutManager instanceof LayoutManager2) {
                return ((LayoutManager2)layoutManager).maximumLayoutSize(target);
            } else {
        ...
        public void layoutContainer(Container target) {
            layoutManager.layoutContainer(target);
        }

        public float getLayoutAlignmentX(Container target) {
            if (layoutManager instanceof LayoutManager2) {
                return ((LayoutManager2)layoutManager).getLayoutAlignmentX(target);
            } else {
        ...
        public float getLayoutAlignmentY(Container target) {
            if (layoutManager instanceof LayoutManager2) {
                return ((LayoutManager2)layoutManager).getLayoutAlignmentY(target);
            } else {
        ...
        public void invalidateLayout(Container target) {
            if (layoutManager instanceof LayoutManager2) {
                ((LayoutManager2)layoutManager).invalidateLayout(target);
            }
        }
...
////////////////
     ...
     * AccessibleFloatedFrame.
     * A new AccessibleFloatedFrame instance is created if necessary.
     *
     * @return an AccessibleFloatedFrame that serves as the
     *         AccessibleContext of this JToolBar
     */
    public AccessibleContext getAccessibleContext() {
        if (accessibleContext == null) {
            accessibleContext = new FloatedFrame.AccessibleFloatedFrame();
        }
     ...
     */
    protected class AccessibleFloatedFrame extends JComponent.AccessibleJComponent {
    ...
    } // inner class AccessibleFloatedFrame
}
